            ...
            {isFundingMatchingPool ? (
              ...
              >
                ...
                <Card.Text className="m-0 fs-6">
                  Suggested at least {roundWeiAmount(suggestedTokenBalance, 6)}
                </Card.Text>
                <OnRampWidget
                  target={
          ...
          <Stack direction="vertical" gap={2}>
            ...
            <Stack direction="vertical">
              ...
              >
                ...
                <Stack direction="horizontal" gap={1} className="w-50 ms-2 p-2">
                  <Image
                    src={superTokenIcon}
              ...
              {!isFundingMatchingPool && (
                ...
                >
                  <Card.Text className="w-33 m-0 fs-5">Est. Matching</Card.Text>
                  <Stack
                    direction="horizontal"
                    gap={1}
