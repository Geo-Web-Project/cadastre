...
function HomeContent ()
{
    return (
        <div style={{ position: "absolute", width: "68%", height: '80%', left: "4%", 
            ...
            <p style={{ fontSize: "28px", lineHeight: "45px" }} >{"The Geo Web is an augmented reality metaverse."}</p>
            ...
            <p style={{ fontSize: "28px", lineHeight: "45px" }} >{"Claim your home or business’s digital land on the Geo Web."}</p> 
            ...
            <p style={{ fontSize: "28px", lineHeight: "45px" }} >{"Browse the Geo Web with a universal geospatial browser."}</p> 
            ...
            <p style={{ fontSize: "28px", lineHeight: "45px" }} >{"The Geo Web is a public good. "}</p> 
            ...
            <p style={{ fontSize: "28px", lineHeight: "45px" }} >{"Why should I care? "}</p> 
...
{   
    return(
        <div style={{position: "absolute", right: 0, top: "100px", width: "22%", height: "200%", 
            ...
            <p style={{ fontSize: "28px", lineHeight: "45px" }}>{"To start please connect your "}</p> 
            <p style={{ fontSize: "28px", lineHeight: "45px" }}>{"Web3 wallet."}</p> 
...
function Home()
{
    return (
        <>
            <div style={{ position: "absolute", left: "-2%", top: "100px", width: "80%", height: "200%",
