...
function ProfileModal(props) {
    ...
    return(
        <Modal show={showProfile} onHide={handleCloseProfile} >
            <Modal.Header style={{ background: "#202333", color: "#2FC1C1" }} closeButton>
            <Modal.Title>Profile</Modal.Title>
            </Modal.Header>
            <Modal.Body style={{ background: "#202333", fontFamily: "Abel", fontStyle: "normal", fontWeight: "normal" }} >

                <div style={{position: "relative", top: -70, display: "flex", flexDirection: "row", alignItems: "center" }}>
                    
                    <img style={{ width: 25, height: 25, left: 40, top: 78 }} src={'./ProfileIcon.png'} />

                    <span style={{ fontSize: 15, lineHeight: 15, color: "#FFFFFF", marginLeft: 10}} > 
                        {addr} 
                    </span>
                ...
                <div style={{ position: "absolute", width: 453, height: 69, left: "4%", top: "40%", background: "#111320", 
                    fontSize: 18, lineHeight: 15, alignItems: "center" }} />
