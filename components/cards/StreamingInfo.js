...
function StreamingInfo({ ETHxBalance }) {
  return (
    <Card border="secondary" className="bg-dark my-5">
      ...
      <Row>
        ...
        <Col>
          <p>
            Your current ETHx balance is <b>{ETHxBalance}</b>.
            We recommend wrapping enough ETH to cover at least&nbsp;
            3 months of payments for ALL of your outstanding streams&nbsp;
